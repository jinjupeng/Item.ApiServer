...
namespace ApiServer.Models.Entity
{
    public partial class ContextMySql : DbContext
    {
        ...
        public virtual Microsoft.EntityFrameworkCore.DbSet<sys_dict> sys_dict { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=127.0.0.1;port=3306;database=apiserver;uid=root;pwd=123456;Charset=utf8;Allow User Variables=True;sslMode=None;", x => x.ServerVersion("8.0.22-mysql"));
            }
        }
